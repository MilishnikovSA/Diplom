...
namespace АИС_отдела_редких_книг.Forms
{
    partial class БИБЛИОТЕКАРЬ
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.bibliotekarTableAdapter = new АИС_отдела_редких_книг.DataSetTableAdapters.BibliotekarTableAdapter();
            ...
            this.authorDataGridView.DataSource = this.bibliotekarBindingSource;
            ...
            this.authorDataGridView.TabIndex = 31;
            // 
            ...
            this.idbibliotekariaDataGridViewTextBoxColumn.ReadOnly = true;
            // 
            ...
            this.bibliotekarBindingSource.DataSource = this.dataSet;
            // 
            // dataSet
            // 
            ...
            this.Name = "БИБЛИОТЕКАРЬ";
            this.Text = "БИБЛИОТЕКАРЬ";
            this.Load += new System.EventHandler(this.БИБЛИОТЕКАРЬ_Load);
        ...
        private DataSetTableAdapters.BibliotekarTableAdapter bibliotekarTableAdapter;
