...
namespace АИС_отдела_редких_книг.Forms
{
    partial class РОЛЬ
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.rolTableAdapter = new АИС_отдела_редких_книг.DataSetTableAdapters.RolTableAdapter();
            ...
            this.radioButton1.Text = "ПО НОМЕРУ РОЛИ";
            ...
            this.authorDataGridView.DataSource = this.rolBindingSource;
            ...
            this.idroliDataGridViewTextBoxColumn.ReadOnly = true;
            // 
            ...
            this.rolBindingSource.DataSource = this.dataSet;
            // 
            // dataSet
            // 
            ...
            this.Name = "РОЛЬ";
            this.Text = "РОЛЬ";
            this.Load += new System.EventHandler(this.РОЛЬ_Load);
        ...
        private DataSetTableAdapters.RolTableAdapter rolTableAdapter;
